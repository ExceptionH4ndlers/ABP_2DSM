    ...
    <FurnasPanoramaContainer>
      ...
      <MainContent $collapsed={sidebarCollapsed}>
        ...
        <Section>
          ...
          <SectionText>
            <strong>• Comissão Mundial de Barragens (WCD):</strong> quando geração hidrelétrica é
            inferior a 0,1 W por m² de área de reservatório, as emissões podem exceder àquelas
            originadas de termelétricas;
          </SectionText>

          <SectionText>
            <strong>• Emissões parecem variar:</strong> em função da profundidade e densidade da
            biomassa alagada;
          </SectionText>

          <SectionText>
            <strong>• O ciclo do carbono:</strong> deve ser avaliado antes e após a instalação da
            formação do reservatório. Estudos devem abordar as interações com as bacias de drenagem;
          </SectionText>

          <SectionText>
            <strong>• Convenção Quadro das Nações Unidas sobre Mudança do Clima (UNFCCC):</strong>{" "}
            Compromisso de elaborar e atualizar periodicamente inventários nacionais de emissões
            antrópicas por fontes e das remoções por sumidouro;
          </SectionText>
          ...
          <SectionText>
            ...
            antrópicas em tais alterações.
          </SectionText>

          <SectionText>
            Os documentos que compõem o Terceiro Relatório de Avaliação do IPCC ("Climate Change
            2001"), confirmam que o aquecimento global nos últimos 50 anos é conseqüência do aumento
            das concentrações de gases de efeito estufa (GEE), originado principalmente da queima de
            combustíveis fósseis. Como resultado, é prevista a ocorrência de eventos climáticos
            extremos e são esperados impactos na circulação e no volume (elevação do nível) dos
            oceanos, nos regimes pluviométricos, na agricultura e na estrutura e produtividade dos
            ecossistemas, com perda da biodiversidade e alterações nos ciclos do carbono e
            nutrientes.
          </SectionText>
          ...
          <SectionText>
            ...
            proveniente da bacia de drenagem (material alóctone).
          </SectionText>

          <SectionText>
            Considerando tal premissa, conclui-se que a fotossíntese não é a fonte principal de
            carbono desses ambientes, mas sim o ambiente circundante. E se a produção primária,
            baseada na fotossíntese, é menor que a atividade respiratória das bactérias, então tais
            sistemas não contribuem para a fixação do carbono atmosférico. Pelo contrário, tornam-se
            fontes emissoras de gás carbônico. Essa abordagem do funcionamento dos sistemas
            aquáticos é relativamente nova e muitos estudos e equipamentos ainda estão sendo
            desenvolvidos para a avaliação das taxas de respiração bacteriana em comparação com a
            produção fotossintética.
          </SectionText>

          <SectionText>
            No rastro desse novo enfoque limnológico, passou-se a questionar a geração de energia
            hidrelétrica como fonte "limpa", já que os reservatórios incorporam grandes quantidades
            da biomassa vegetal que cobria a bacia de acumulação. Cogitou-se que a decomposição
            dessa imensa fonte de carbono seria responsável por emissões de gases de efeito estufa
            em níveis equivalentes aos de termelétricas de mesma potência.
          </SectionText>
          ...
          <SectionText>
            ...
            metano (CH₄), gás carbônico (CO₂) e óxido nitroso (N₂O). Neste sentido, o Brasil vem
            realizando inventários nacionais sobre as emissões de GEE (www.mct.gov.br). Com relação
            à geração hidrelétrica, inicialmente, foram consideradas apenas as emissões de CH₄ dos
          ...
          <SectionText>
            ...
            não só as emissões de CH₄, como também as emissões de gás carbônico dissolvido,
            ...
            no hipolímnio, como produto da decomposição anaeróbia da vegetação alagada.
          </SectionText>

          <SectionText>
            Outra contribuição importante deste trabalho foi a utilização da curva cota-área do
          ...
          <SectionText>
            ...
            aperfeiçoamento e padronização de métodos.
          </SectionText>

          <SectionText>
            O estado-da-arte indica que, em casos onde a geração hidrelétrica é inferior à 0,1 W por
            metro quadrado de área de reservatório, existe a possibilidade das emissões de GEE serem
            superiores àquelas que seriam originadas de uma termelétrica gerando uma quantidade de
            energia equivalente (Rosa & dos Santos, 2000).
          </SectionText>
          ...
          <SectionText>
            <strong>1 – Qual o balanço das emissões de GEE por reservatórios?</strong>
            <br />
            <strong>2 – Energia hidrelétrica contribui para o incremento do efeito estufa?</strong>
            <br />
            <strong>3 – Quais as diferenças nos métodos de estimativa de fluxo de GEE?</strong>
            <br />
            <strong>
              4 – Até que ponto dependemos da resolução temporal e espacial dos processos para o
              desenvolvimento de modelos adequados de compreensão e previsão?
            </strong>
          </SectionText>

          <SectionText>
            O projeto envolverá o Departamento de Meio Ambiente (DMA.T) de FURNAS Centrais Elétricas
            S.A, o Instituto Alberto Luiz Coimbra de Pós-Graduação e Pesquisa de Engenharia –
            COPPE/UFRJ, o Instituto Nacional de Pesquisas Espaciais – INPE, a Universidade Federal
            de Juiz de Fora – UFJF, o Instituto Internacional de Ecologia – IEE e um consultor
            estrangeiro, especialista em avaliar emissões originadas do sedimento, com experiência
            no Chile, Europa, África, Nova Zelândia, Canadá e Japão.
          </SectionText>

          <SectionText>
            Esse intercâmbio permitirá a transferência da tecnologia de medição das emissões
            provenientes do sedimento e o desenvolvimento de modelos para a avaliação das emissões
            de gases em reservatórios construídos em ambientes de Cerrado. Cada especialista tratará
            de desenvolver aspectos relacionados ao ciclo do Carbono e à quantificação das emissões
            pelos reservatórios.
          </SectionText>
          ...
          <SectionText>
            <strong>1º ano:</strong> UHE Serra da Mesa e APM Manso;
            <br />
            <strong>2º ano:</strong> UHE Itumbiara e UHE Corumbá;
            <br />
            <strong>3º ano:</strong> UHE Marimbondo e UHE Porto Colômbia;
            <br />
            <strong>4º ano:</strong> UHE L.C.B. de Carvalho e UHE Mascarenhas de Morais; UHE Furnas;
            <br />
            <strong>5º ano:</strong> UHE Funil e APM Manso;
            <br />
            <strong>6º ano:</strong> desenvolvimento de modelos e elaboração de relatório final.
          </SectionText>

          <SectionText>
            A emissões de carbono pelo APM Manso deverão ser remensuradas no quinto ano para que
            seja avaliado o efeito do tempo sobre as taxas obtidas naquele reservatório ainda em
            fase de estabilização.
          </SectionText>

          <SectionText>Serão elaborados os seguintes documentos:</SectionText>

          <SectionText>
            <strong>• relatórios de andamento,</strong> apresentando os resultados obtidos nas duas
            primeiras viagens de campo de cada grupo de reservatórios, a serem apresentados nos
            meses de julho e outubro;
            <br />
            <strong>• relatórios anuais</strong> concluindo sobre as emissões e os fatores
            predominantes do ciclo de carbono de cada reservatório; a serem apresentados no mês de
            março de cada ano;
            <br />
            <strong>• relatório síntese</strong> apresentando as conclusões gerais do projeto: o
            balanço do carbono nos reservatórios de FURNAS Centrais Elétricas S.A.
          </SectionText>
