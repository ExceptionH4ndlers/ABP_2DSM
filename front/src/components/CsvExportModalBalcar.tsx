...
interface CsvExportModalBalcarProps {
  $isOpen: boolean;
  onClose: () => void;
...
export const CsvExportModalBalcar: React.FC<CsvExportModalBalcarProps> = ({
  $isOpen,
  onClose,
    ...
    <>
      ...
      <Overlay $isOpen={$isOpen} onClick={onClose}>
        <Content onClick={(e) => e.stopPropagation()}>
          <Title>
            <Download size={20} /> Exportar CSV (BALCAR)
          </Title>
          ...
          <FormGroup>
            <Label>
              <Settings size={16} style={{ marginRight: 6 }} /> Reservatório
            </Label>
            <Select
              value={reservatorio}
              onChange={(e) => {
...
export default CsvExportModalBalcar;
