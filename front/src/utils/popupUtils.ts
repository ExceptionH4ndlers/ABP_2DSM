...
export function createStationPopupHTML(point: MapPoint): string {
  ...
  return `<div style="min-width: 200px; width: max-content; max-width: 600px; background: white; border-radius: 20px; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.15), 0 2px 8px rgba(0, 0, 0, 0.1); border: 2px solid #e2e8f0; overflow: visible; margin: 0; padding: 0; position: relative;">
      <div style="background: ${getGradient(point.type)}; padding: 16px 50px 16px 18px; color: white; display: flex; align-items: flex-start; gap: 12px; position: relative; overflow: visible;">
